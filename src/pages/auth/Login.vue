            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    ...
                    <div>
                        ...
                        <div v-if="error" class="text-red-500 font-medium mb-4 p-3 bg-red-100 dark:bg-red-900/20 rounded-md">{{ error }}</div>
                        ...
                        <form @submit.prevent="login">
                            ...
                            <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                                ...
                                <router-link to="/auth/forgot-password"><span class="font-medium no-underline ml-2 text-right cursor-pointer text-primary">Forgot password?</span></router-link>
                            </div>
